...
static inline math4 math4_identity () {
    math4 result_matrix = {{{0}}};
    result_matrix.matrix [0][0] = 1.0;
    result_matrix.matrix [1][1] = 1.0;
    result_matrix.matrix [2][2] = 1.0;
    result_matrix.matrix [3][3] = 1.0;
    return result_matrix;
} //Viewing Perspective
...
static inline math4 math4_perspective_fov (float field_of_view, float aspect_ratio, float near_plane, float far_plane) {
    ...
    result_matrix.matrix [3][2] = (2.0 * far_plane * near_plane) / (near_plane - far_plane);
    result_matrix.matrix [2][3] = -1.0;
    return result_matrix;
